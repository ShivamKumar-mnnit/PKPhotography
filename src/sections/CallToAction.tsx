...
export const CallToAction = () => {
  return(
    <section className="bg-gradient-to-b from-[#eae8e4] to-[#000000] py-24 overflow-x-clip">
      ...
      <div className="flex h-30 mt-5 items-center justify-center">
        ...
        <p className="section-description mt-5 mx-5 text-white z-30">Whenever you are looking for professional headshots or event coverage, we offer services that align with your needs. Sign up today to discover the perfect package for you.</p>
...
<Image src={springImage} alt="spring" width={360} className="absolute -right-[331px] -top-[19px] lg:-right-[251px] lg:-top-[19px]" />
        ...
        <div className="flex gap-2 mt-10 justify-center">
          ...
          <button className="btn btn-text text-white"><span>Learn more</span>
